...
public class J2022xxxxxxxx_4 extends JFrame {
    //****************************************************************************************************************//
    //成员变量
    //****************************************************************************************************************//

    private static final String title = "studentNumber－studentName－Java 程序设计综合实验";

    //      菜单栏相关
    private static final JMenuBar mb = new JMenuBar();
    private static final JMenu mFile = new MyMenu("文件(F)", KeyEvent.VK_F);
    private static final JMenu mHomeWork = new MyMenu("Java上机题目");
    private static final JMenu mPhone = new MyMenu("通讯录(C)", KeyEvent.VK_C);
    private static final JMenuItem miFileNew = new JMenuItem("新建(N)", KeyEvent.VK_N);
    private static final JMenuItem miFileOpen = new JMenuItem("打开(O)...", KeyEvent.VK_O);
    private static final JMenuItem miFileSave = new JMenuItem("保存(S)", KeyEvent.VK_S);
    private static final JMenuItem miFileFont = new JMenuItem("字体与颜色(F)...", KeyEvent.VK_F);
    private static final JMenuItem miFileBG = new JMenuItem("背景颜色(B)...", KeyEvent.VK_B);
    private static final JMenuItem miFileQuit = new JMenuItem("退出(X)", KeyEvent.VK_X);
    private static final JMenuItem miHWHuiwen = new JMenuItem("回文数");
    private static final JMenuItem miHWTrans = new JMenuItem("数字与英文互译");
    private static final JMenuItem miHWCompute = new JMenuItem("统计英文数据");
    private static final JMenuItem miHWPhoneCheck = new JMenuItem("手机号合法性判断");
    private static final JMenuItem miHWSum = new JMenuItem("文本文件求和");
    private static final JMenuItem miPhoneDisplay = new JMenuItem("通讯录维护");
    private static final JMenuItem miPhoneSave = new JMenuItem(" 通讯录储存文件设置");
    ...
    //初始化
    //****************************************************************************************************************//
    private J2022xxxxxxxx_4(String title) {
        super(title);
    ...
    private void readinFont() {
                ...
                BufferedWriter writer =
                        new BufferedWriter(
                                new OutputStreamWriter(
                                        new FileOutputStream("font.properties"),
        ...
        try {
            InputStreamReader reader = new InputStreamReader(new FileInputStream(fontConfig), StandardCharsets.UTF_8);
    ...
    private void readinDataPath() {
        ...
        if (!fontConfig.exists()) {
            try {
                fontConfig.createNewFile();
                BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("datapath.properties"), StandardCharsets.UTF_8));
    ...
    private void checkQuit() {
        ...
        if (!textContent.equals(ta.getText())) {
            ...
            int ret = JOptionPane.showConfirmDialog(this, "确定要退出系统吗？", "Java程序设计综合实验", JOptionPane.YES_NO_OPTION);
            switch (ret) {
                case JOptionPane.YES_OPTION:
                    exit();
                    break;
    ...
    private void phoneCheck() {
        ...
        ActionListener listener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ok = s.length() == 13 || s.length() == 14 || s.length() == 15 || s.length() == 17;
                if (split.length == 2)
    ...
    private void saveFont() {
        ...
        try {
            BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("font.properties"), StandardCharsets.UTF_8));
    ...
    public static void main(String[] args) {
        J2022xxxxxxxx_4 fr = new J2022xxxxxxxx_4(title);
